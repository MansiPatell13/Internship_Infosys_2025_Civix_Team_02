...
//       reader.onloadend = () => {
//         setPetition({ ...petition, image: reader.result });
//       };
...
//       alert("Please fill in title and description and location");
//       return;
//     }
...
//       if (!response.ok) throw new Error("Failed to createpetition");

//       const result = await response.json();
//       console.log("Petition Created: ", result);

//       const allRes = await fetch("http://localhost:4000/api/petitions");
//       const allPetition = await allRes.json();
//       console.log("All petition after create: ", allPetition);

//       alert("✅ Petition published successfully!");
//       navigate("/petition-head");
//     } catch (error) {
//       console.error(error);
//       alert("❌ Error publishing petition");
//     }
//   };
...
//           <div className="mb-3">
//             <label className="form-label fw-bold">Poll Question<span className="text-danger">*</span></label>
//             <input
//               type="text"
...
//                 <option value="Education">Health & Safety</option>
//                 <option value="Education">Local Government & Policy</option>
//                 <option value="Education">Community & Social Issues</option>
//                 <option value="Education">Infrastructure & Utilities</option>
//                 <option value="Education">Public Services</option>
//                 <option value="Education">Animal Welfare</option>
//               </select>
//             </div>
