      ...
      <div className="main">
        ...
        <div className="box-left">
          ...
          <div className="option-box">
            <Link to="/home" className="o1 o3" style={{ display: "flex", alignItems: "center" }}>
              <FaHome style={{ marginRight: "7px" }} />
              Dashboard
            </Link>

            <Link to="/petition-head" className="o1 o3" style={{ display: "flex", alignItems: "center" }}>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-section links">
            ...
            <Link to="/petition" className="f1">Petitions</Link>
